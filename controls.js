...
function addBtnHome() {
  ...
  if (referrer.indexOf("https://76ezgames.github.io/") !== -1) {
    ...
    e.id = 'inGame';
    e.innerHTML = `
      <img src="https://accessgames.github.io/imgs/branding/accessgameslogo.png" width="150px" height="60px" alt="Go to Access Games">`;
    document.getElementsByTagName('body')[0].appendChild(e);
  }
}
...
function returnHome(){
    ...
    var newWindow = window.open("https://accessgames.github.io", "_blank");
    newWindow.document.title = "Access Academy Games";
}
function opendiscord(){
    window.open("https://accessgames.github.io");
}
